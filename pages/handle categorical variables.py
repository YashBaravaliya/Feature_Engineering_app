...
with st.container():
    st.sidebar.header("Handle Categorical Variables")
    ...
    encoding = st.sidebar.selectbox("Categorical Encoding", list(encoding_options.keys()))
    ...
    st.sidebar.dataframe(object_columns)
